...
class MarineWeather(BaseForecast):
    ...
    def __init__(
        ...
        - wave_type (str): Ocean wave type; must be one of the following:
            ...
            - `swell` (Waves traveling across long distances)
    ...
    def wave_type(self, __value: str) -> None:
        ...
        # Stores the wave type parameter for internal usage by
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"past_days={self._past_days}, timefmt={self._timefmt!r})"
        )
    ...
    def get_hourly_summary(self) -> pd.DataFrame:
        """
        Extracts hourly marine weather forecast summary data.
